...
require_once 'vendor/silverstripe-archive/silverstripe-bbcodeparser/thirdparty/HTML_BBCodeParser2/HTML/BBCodeParser2.php';
...
class HTML_BBCodeParser2Test extends PHPUnit_Framework_TestCase
{
    ...
    public function emailBBCode($bbc, $funcNam)
    {
    ...
    public function imgBBCode($bbc, $funcNam)
    {
    ...
    public function basicBBCode($bbc, $funcNam)
    {
    ...
    public function listBBCode($bbc, $funcNam)
    {
    ...
    public function linkBBCode($bbc, $funcNam)
    {
        $this->assertEquals(
    ...
    public function extBBCode($bbc, $funcNam)
    {
